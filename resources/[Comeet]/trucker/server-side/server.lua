...
function cRP.paymentMethod()
	...
	if user_id then
		...
		vRP.generateItem(user_id,"plasticbottle",math.random(8,12),1)
		vRP.generateItem(user_id,"glassbottle",math.random(8,12),1)
		vRP.generateItem(user_id,"elastic",math.random(8,12),1)
		vRP.generateItem(user_id,"metalcan",math.random(8,12),1)
		vRP.generateItem(user_id,"battery",math.random(8,12),1)
		vRP.generateItem(user_id,"fabric",math.random(4,6),1)
