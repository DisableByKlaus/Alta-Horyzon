...
$( "#sombrancelha" ).click(function() {
	$("#Blush-Button").css("display", "none");
	$("#Barba-Button").css("display", "none");
	$("#Batom-Button").css("display", "none");
	$("#maquiagem-Button").css("display", "none");

	$("#Sombancelha-Button").css("display", "block");
});

$( "#cabelo" ).click(function() {
	$("#Blush-Button").css("display", "none");
	$("#Barba-Button").css("display", "none");
	$("#Batom-Button").css("display", "none");
	$("#maquiagem-Button").css("display", "none");
	$("#Sombancelha-Button").css("display", "none");

	$("#Cabelo-Button").css("display", "block");
});
...
$( "#barba" ).click(function() {
	...
	$("#Batom-Button").css("display", "none");
	$("#maquiagem-Button").css("display", "none");
	$("#Cabelo-Button").css("display", "none");
	$("#Sombancelha-Button").css("display", "none");

	$("#Barba-Button").css("display", "block");
});
...
$( "#blush" ).click(function() {
	...
	$("#Blush-Button").css("display", "block");
});
