...
function cRP.paymentRobbery()
	...
	if user_id then
		...
		vRP.generateItem(user_id,robberys[rand]["item"],value,1)
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- INSERTPEDLIST
