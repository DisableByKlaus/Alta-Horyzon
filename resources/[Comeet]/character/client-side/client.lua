...
RegisterNUICallback("updateSkin",function(data)
	...
	if data["value"] then
		...
		SendNUIMessage({ openCharacter = false })
	end

	TriggerEvent("character:apply",myClothes)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- ROTATELEFT
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("character:apply",function(status)
	myClothes = {}
...
RegisterNetEvent("character:show")
AddEventHandler("character:show",function(enable)
...
RegisterNetEvent("character:showItem")
AddEventHandler("character:showItem",function(enable)
