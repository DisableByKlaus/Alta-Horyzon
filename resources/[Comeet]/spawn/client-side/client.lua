...
-----------------------------------------------------------------------------------------------------------------------------------------
local pedCoords = {
	{ -412.6,1071.62,323.84,167.25,"random@shop_tattoo","_idle_a" },
	{ -411.27,1071.3,323.84,164.41,"anim@heists@heist_corona@single_team","single_team_loop_boss" },
	{ -409.76,1070.85,323.84,164.41,"jh_1_ig_3-2","cs_jewelass_dual-2" },
	{ -409.06,1070.58,323.84,164.41,"oddjobs@taxi@","idle_a" },
	{ -408.1,1070.3,323.84,147.41,"amb@world_human_bum_standing@twitchy@base","base" }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- OTHERLOCATES
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("onClientResourceStart",function(resourceName)
	...
	SetEntityCoords(ped,-410.83,1067.4,324.48,false,false,false,false)
	LocalPlayer["state"]["Invisible"] = true
	SetEntityVisible(ped,false,false)
	FreezeEntityPosition(ped,true)
	SetEntityInvincible(ped,true)
	SetEntityHealth(ped,400) -- caso de erro 
	...
	--SetCamCoord(Camera,-408.13,1063.02,323.84,164.41)
...
RegisterNUICallback("spawnChosen",function(data)
	...
	if data["hash"] == "spawn" then
		...
		SetEntityCoords(ped,805.05,1275.22,360.38,274.97,false,false,false,false)
